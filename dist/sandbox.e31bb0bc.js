...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/Test.elm":[function(require,module,exports) {
(function(scope){
'use strict';
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Count On Me')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
...
var _Test = require("./src/Test.elm");
...
},{"./src/Test.elm":"src/Test.elm","./style.scss":"style.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
